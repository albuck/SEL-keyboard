...
+ Compact split layout SEL-SF (14 cm × 34++ cm) for small form factor folding or split keyboard or as little more compact full SEL version (in this case a single Function key is enough).
